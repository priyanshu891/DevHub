...
%>
									<tr>
										<td colspan="4">Expert Comments/Solutions</td>
									</tr>
									<tr>
										<td colspan="4">
											<form name="form" method="post" action="addcomment.jsp">
												<textarea cols="60" rows="4" class="form-control" name="sol"></textarea>
												...
												<input type="hidden" name="expert" value="<%=session.getAttribute(" user ")%>" />
												<br />
												<br />
												<div align="center">
